...
@section('title')
    Daftar Pendapatan {{ tanggal_indonesia($awal, false) }} s/d {{ tanggal_indonesia($akhir, false) }}
@endsection
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <a href="laporan/pdf/{{$awal}}/{{$akhir}}" class="btn btn-info">
