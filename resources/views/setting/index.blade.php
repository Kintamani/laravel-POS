        ...
        <div class="box">  
          ...
          <form class="form form-horizontal" data-toggle="validator" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body">
              ...
              {{--  kartu member  --}}
              <div class="form-group">
                <label for="kartu_member" class="col-md-2 control-label">
                  Kartu Member
                </label>
                <div class="col-md-4">
              ...
              {{--  telepon  --}}
              <div class="form-group">
                <label for="diskon_member" class="col-md-2 control-label">
                  Diskon Member (%)
                </label>
                <div class="col-md-2">
              ...
              {{--  tipe nota  --}}
              <div class="form-group">
                <label for="tipe_nota" class="col-md-2 control-label">
                  Tipe Nota
                </label>
                <div class="col-md-2">
      ...
      function showData(){
        $.ajax({
          ...
          success : function(data){
            ...
            d = new Date();
            $('.tampil-logo').html(
              '<img src="images/'+data.logo+'?'+d.getTime()+'"width="200">'
            );
            $('.tampil-kartu').html(
              '<img src="images/'+data.kartu_member+'?'+d.getTime()+'"width="300">'
            );
          },
          error : function(){
            alert("tidak dapat menyimpan data")
